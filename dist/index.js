...
var gasStatsData = require('@frontier-token-research/pm-contracts/build/gas-stats.json');
var gasLimit = 4e6;
...
var contractArtifacts = ['Event', 'CategoricalEvent', 'ScalarEvent', 'EventFactory', 'ERC20', 'HumanFriendlyToken', 'WETH9', 'CentralizedOracle', 'CentralizedOracleFactory', 'UltimateOracle', 'UltimateOracleFactory', 'LMSRMarketMaker', 'Market', 'StandardMarket', 'StandardMarketFactory'].map(function (name) {
    return require('@frontier-token-research/pm-contracts/build/contracts/' + name + '.json');
});
...
var Gnosis = function () {
    ...
    (0, _createClass3.default)(Gnosis, [{
        ...
        key: 'setWeb3Provider',
        value: function () {
            var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(provider, defaultAccount) {
                var _this2 = this;
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 25:
                                 ...
                                 */
                                this.trySettingContractInstance('lmsrMarketMaker', this.contracts.LMSRMarketMaker)].concat((0, _toConsumableArray3.default)((0, _toPairs3.default)(this.instanceNames).map(function (_ref4) {
        ...
        value: function () {
            var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(instanceName, contract) {
        ...
        key: 'importContracts',
        value: function () {
            var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(artifacts, instanceNames) {
                var _this3 = this;
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.next = 4;
                                return _promise2.default.all((0, _toPairs3.default)(instanceNames).map(function (_ref8) {
